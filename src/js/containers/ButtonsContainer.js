...
const ButtonsContainer = ({ selectNumber, selectOperator }) => (
  <React.Fragment>
    ...
    <button value="/" onClick={() => selectOperator(2)} className="buttonStyle divide" type="submit">/</button>
    <button value="7" onClick={() => selectNumber(7)} className="buttonStyle seven" type="submit">7</button>
